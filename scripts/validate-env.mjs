...
const envSchema = z.object({
  ...
  CLIMATIQ_API_KEY: optionalString(z.string().min(10)),
  CLIMATIQ_DATA_VERSION: optionalString(z.string().min(2)),
  CLIMATIQ_ACTIVITY_ID_GASOLINE: optionalString(z.string().min(10)),
  CLIMATIQ_ACTIVITY_ID_DIESEL: optionalString(z.string().min(10)),
