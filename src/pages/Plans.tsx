    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto space-y-8 py-8 px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 animate-fade-in animation-delay-100">
          {/* Basic Plan */}
          <div className="bg-zinc-900/50 backdrop-blur-sm p-8 rounded-md border border-zinc-800 flex flex-col hover:border-zinc-700 transition-colors">
            <div className="mb-6">
            ...
            <Button 
              variant="outline" 
              className="w-full py-6 rounded-md border-zinc-700 hover:bg-zinc-800" 
          ...
          {/* Pro Plan */}
          <div className="bg-zinc-900/50 backdrop-blur-sm p-8 rounded-md border-2 border-zinc-700 relative flex flex-col hover:border-zinc-600 transition-colors">
            ...
            <Button 
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-6 rounded-md"
        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm p-8 rounded-md border border-zinc-800 text-center animate-fade-in animation-delay-200">
