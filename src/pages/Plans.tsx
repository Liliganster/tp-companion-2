      ...
      return [
        {
          ...
          features: ["Unbegrenzte Fahrten", "5 Projekte", "Basisberichte", "5 KI-Extraktionen/Monat", "CSV-Export"],
      ...
      return [
        {
          ...
          features: ["Unlimited trips", "5 projects", "Basic reports", "5 AI extractions/month", "CSV export"],
    ...
    return [
      {
        ...
        features: ["Viajes ilimitados", "5 proyectos", "Informes básicos", "5 extracciones IA/mes", "Exportación CSV"],
