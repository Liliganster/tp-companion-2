export function buildUniversalExtractorPrompt(text: string) {
  return [
    ...
    "- Si el documento usa un venue explicito como '@Le Meridien', '@Hotel Imperial', '@Flex Cafe' o similar, ese venue es valido como ubicacion si aparece en filas de Location/Set.",
    "- Si la fila mezcla venue + subespacio interno ('Foyer', 'Your Bar', 'Keller', 'Lobby', 'Room', 'Stock -1', 'Erdgeschoss'), devuelve el venue principal, no la sala interna.",
    "- Si la misma fila incluye venue + direccion exacta, usa la direccion exacta. Si solo hay venue + notas internas, usa el venue + ciudad.",
    "- Si aparece un enlace 'maps.app.goo.gl' junto al venue, usa el venue de esa misma fila como referencia principal.",
    "- Ejemplo: 'Foyer im Erdgeschoss - siehe Plan @Le Meridien' -> 'Le Meridien, Wien'",
    "- Ejemplo: 'Stock -1: Keller im Velvet - siehe Plan @Le Meridien' -> 'Le Meridien, Wien'",
    "",
