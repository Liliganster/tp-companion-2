  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Parámetros de vehículo y costes</DialogTitle>
        </DialogHeader>

        <div className="grid grid-cols-3 gap-4 py-4">
          <div className="space-y-2">
            <Label className="text-sm text-muted-foreground">Tipo de vehículo</Label>
          ...
          <div className="space-y-2">
            <Label className="text-sm text-muted-foreground">Consumo de Combustible</Label>
            <Input
              type="text"
          ...
          <div className="space-y-2">
            <Label className="text-sm text-muted-foreground">Precio del Combustible</Label>
            <Input
              type="text"
              value={fuelPrice}
